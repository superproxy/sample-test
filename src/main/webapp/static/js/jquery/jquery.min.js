...
(function (e, undefined) {
    ...
    t = x(o), function (e, undefined) {
        ...
        o = ut.isXML = function (e) {
            ...
            return t !== c && 9 === t.nodeType && t.documentElement ? (c = t, f = t.documentElement, p = !o(t), b.getElementsByTagName = at(function (e) {
                ...
                return e.innerHTML = "<div class='test'></div><div class='test i'></div>", e.firstChild.className = "i", 2 === e.getElementsByClassName("i").length
        ...
        Nt.prototype = r.filters = r.pseudos, r.setFilters = new Nt, b.sortStable = y.split("").sort(S).join("") === y, l(), [0, 0].sort(S), b.detectDuplicates = E, at(function (e) {
            if (e.innerHTML = "<test href='#'></test>", "#" !== e.firstChild.getAttribute("href")) {
    ...
    var yt, vt, xt = /^(none|table(?!-c[ea]).+)/, bt = /^margin/, wt = RegExp("^(" + b + ")(.*)$", "i"), Tt = RegExp("^(" + b + ")(?!px)[test-z%]+$", "i"), Ct = RegExp("^([+-])=(" + b + ")", "i"), kt = {BODY: "block"}, Nt = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, Et = {
    ...
    var vn, xn, bn = /^(?:toggle|show|hide)$/, wn = RegExp("^(?:([+-])=|)(" + b + ")([test-z%]*)$", "i"), Tn = /queueHooks$/, Cn = [Dn], kn = {
        "*": [function (e, t) {
